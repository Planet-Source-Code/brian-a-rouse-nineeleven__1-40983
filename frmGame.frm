...
Begin VB.Form frmGame 
   BackColor       =   &H80000012&
   BorderStyle     =   0  'None
   Caption         =   "Brian's 911 Version 2 WWW.BROuseSoftware.Net"
   ClientHeight    =   6180
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11880
   ...
   Begin VB.Label lblICBMInfo 
      AutoSize        =   -1  'True
      BackColor       =   &H00000000&
      Caption         =   "U.S. Patriot Missiles (ABM's) Remaining"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   9.75
         Charset         =   0
...
If iNumHit >= iNumTargets Then
    MsgBox "You are a disgrace!", vbExclamation, "Game Over!"
    frmGame.Hide
    Unload Me
    End
